...
handle a code is a necessity. Serverless, containers, cloud, CI/CD and git are not foreign buzzwords for me. 
Nevertheless, during the last 5 years I was fortunate to had worked and lived in interesting places and experience 
firsthand what others might read in adventure books. On the less bright side, I do not have much real-life exposure 
into the DevOps and SysOps world as I was in environments that embraced the older way of “doing” IT. To keep my 
...
zuri_job_description_data = """Responsible for managing an IT department from managerial and technical perspective. 
My main duty was to ensure 24/7 smooth IT operations for both internal and external customers with strong emphasis on 
maintaining tight budget especially during the pandemic ara. I was leading a small team of local personnel with whom 
we performed most of the tasks ourselves with excellent results. The place due to its nature needed 24/7 attention, 
high speed and quality in execution was expected. The workload was very varied and rich, you were expected to handle 
tasks from financial planning, hiring and attendance to negotiation with vendors, communication with government 
agencies, sourcing and purchasing hardware to completely manage campus-like server, network and application 
infrastructure. The size of the property was 14 acres and just to create a picture. There was around 220 active 
access points over 11km of optical cabling, over 350 employees or over 100 high profile paying clients. I am very 
happy to provide references and give you more details."""
